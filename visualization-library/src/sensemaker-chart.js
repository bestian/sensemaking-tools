...
const defaultTheme = {
    colors: [
        "#AFB42B", "#129EAF", "#F4511E", "#3949AB", "#5F8F35",
        "#9334E6", "#E52592", "#00897B", "#E8710A", "#1A73E8",
    ],
...
class SensemakerChart extends HTMLElement {
    ...
    get data() { return this._rawDataInput; }

    set summaryData(value) {
        this._rawSummaryInput = value;
        this.loadSummaryData();
    }
    get summaryData() { return this._rawSummaryInput; }
    ...
    async attributeChangedCallback(name, oldValue, newValue) {
        ...
        if (['view', 'chart-type', 'topic-filter', 'alt-text'].includes(name)) {
            ...
            this.setAttribute('aria-label', customAlt || generateAltText(
                this._data,
...
function registerComponent() {
    ...
    console.log('CustomElements available:', typeof window !== 'undefined' && !!window.customElements);
