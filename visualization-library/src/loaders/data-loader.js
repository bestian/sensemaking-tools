...
export class DataLoader {
    ...
    static _transformData(data, transform = true) {
        ...
        if (!Array.isArray(recordsToProcess)) {
            console.warn("_transformData: Expected an array for transformation, but received:", recordsToProcess);
            return [];
        }
        ...
        return recordsToProcess
            ...
            .map((item) => {
                ...
                transformedItem.topics = Array.isArray(transformedItem.topics) ? transformedItem.topics : [transformedItem.topics || ""];
                transformedItem.subtopics = Array.isArray(transformedItem.subtopics) ? transformedItem.subtopics : [transformedItem.subtopics || ""];
