...
export function render(
    ...
    const uniqueTopics = new Set(filteredData.flatMap(d => 
    ...
    const clusterBubbleSize = Math.max(20, Math.min(clusterGroupWidth, clusterGroupHeight) - clusterGroupPadding * 2);
    ...
    const scatterBubbleSize = Math.max(20, Math.min(scatterGroupWidth, scatterGroupHeight) - scatterGroupPadding * 2);
    ...
    chartContainer.style.height = view == "cluster" ? `${dimensions.views[view].height + legendHeight}px` : "auto";
    ...
    const createPaginationControls = (isScatter) => {
        ...
        prevButton.onclick = () => {
            if (dimensions.views.scatter.shiftIndex > 0) {
                ...
                mainContainer.selectAll(".vertical.grid-line")
                    .transition()
                    .duration(300)
                    .attr("x1", function() {
                ...
                mainContainer.selectAll(".topic-label")
                    .transition()
                    .duration(300)
                ...
                // Update bubbles
                mainContainer.selectAll("circle.element")
                    .transition()
                    .duration(300)
                    ...
                    .style("opacity", function(d) {
                        ...
                        return (newX >= dimensions.views.scatter.xOffset && 
                                newX <= dimensions.views.scatter.xOffset + dimensions.views.scatter.innerWidth) ? 0.7 : 0;
                    });
            }
        };
