...
export default {
    ...
    argTypes: {
        ...
        summarySource: {
            name: "summary-source",
            control: "text",
            description: "Local path or remote URL to the summary data JSON. Optional, but required for theme summaries.",
            table: {
                type: { summary: "string" },
                defaultValue: { summary: "none" },
                category: "Optional",
        ...
        view: {
            ...
            description: 'Display mode: "cluster" (circle packing) or "scatter" (distributed). Can be set statically or dynamically via DOM manipulation.',
            table: {
                type: { summary: "string" },
        ...
        topicFilter: {
            name: "topic-filter",
            control: "text",
            description: "Semicolon-separated list of topics to filter data. Can also prefix with '!' to exclude topics.",
            table: {
                type: { summary: "string" },
                defaultValue: { summary: "none" },
                category: "Required",
...
// Basic template
const Template = ({ id, dataSource, summarySource, view, topicFilter, colors, fontFamily, altText }) => {
        return `
    <sensemaker-chart
      id="${id}"
...
const ViewToggleTemplate = ({ dataSource, summarySource, topicFilter, colors, fontFamily, altText }) => {
