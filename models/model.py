...
class Model(ABC):
  ...
  Different implementations that call different LLM APIs will inherit this class
  and provide concrete implementations that follow this structure.
  """
  ...
  async def generate_data(
    ...
    Args:
        prompt: The instructions and data to process as a prompt.
        schema: The Pydantic model (or a list of Pydantic models/scalars) to use
          for parsing and validating the structured data.
