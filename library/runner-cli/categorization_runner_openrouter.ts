...
async function main(): Promise<void> {
  ...
  program
    ...
    .option(
      "-m, --model <model>",
      "OpenRouter model to use (e.g., 'openai/gpt-4o', 'anthropic/claude-3.5-sonnet', 'minimax/minimax-m2.5', 'z-ai/glm-5'). Defaults to OPENROUTER_MODEL env var or 'openai/gpt-4o'."
    )
    .option(
      "-f, --forceRerun",
