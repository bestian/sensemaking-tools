...
export const TOPIC_SUMMARIES = {
  topicSummary: {
    ...
    "de": "Dieses Thema umfasste {subtopicCount} Unterthemen, bestehend aus insgesamt {statementCount} Aussagen."
  },
  relativeAgreement: {
    ...
    "de": "Dieses Unterthema wies im Vergleich zu den anderen Unterthemen {level} auf."
  }
};
